...
################################################################################
# Author  : Zack Rimshnick
# Version : 1
# Date    : 10/25/2022
# Description : Test cases for inversion counter. Zack Rimshnick
...
run_test_with_args_and_input "slow" "2 4 5 6 7"   "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_with_args_and_input "slow" "2 4 7 8 3"   "Enter sequence of integers, each followed by a space: Number of inversions: 3"
run_test_with_args_and_input "slow" "4 4 4 4 4"   "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_with_args_and_input "slow" "2 3 2 3"   "Enter sequence of integers, each followed by a space: Number of inversions: 1"
run_test_with_args_and_input "slow" "2 3 2 3 2 3"   "Enter sequence of integers, each followed by a space: Number of inversions: 3"
run_test_with_args_and_input "slow" "-2 3 -1 4 9"   "Enter sequence of integers, each followed by a space: Number of inversions: 1"
run_test_with_args_and_input "slow" "-3 5 -2 4 9 -1"   "Enter sequence of integers, each followed by a space: Number of inversions: 5"
run_test_with_args_and_input "slow" "$(echo {1..50000})" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_with_args_and_input "slow" "$(echo {50000..1})" "Enter sequence of integers, each followed by a space: Number of inversions: 1249975000"
...
run_test_with_args_and_input "" "2 4 5 6 7"   "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_with_args_and_input "" "2 4 7 8 3"   "Enter sequence of integers, each followed by a space: Number of inversions: 3"
run_test_with_args_and_input "" "4 4 4 4 4"   "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_with_args_and_input "" "2 3 2 3"   "Enter sequence of integers, each followed by a space: Number of inversions: 1"
run_test_with_args_and_input "" "2 3 2 3 2 3"   "Enter sequence of integers, each followed by a space: Number of inversions: 3"
run_test_with_args_and_input "" "-2 3 -1 4 9"   "Enter sequence of integers, each followed by a space: Number of inversions: 1"
run_test_with_args_and_input "" "-3 5 -2 4 9 -1"   "Enter sequence of integers, each followed by a space: Number of inversions: 5"
run_test_with_args_and_input "" "$(echo {1..50000})" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_with_args_and_input "" "$(echo {50000..1})" "Enter sequence of integers, each followed by a space: Number of inversions: 1249975000"
